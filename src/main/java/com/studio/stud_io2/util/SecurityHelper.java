...
/**
 * Helper de Seguridad - Gesti�n de roles sin XavaPro
 * 
 * Implementa un sistema de roles basado en convenciones de nombres de usuario
 * ya que OpenXava gratuito no incluye gesti�n de roles desde interfaz.
 * 
 * CONVENCIONES:
 * - admin* =�� ADMINISTRADOR
...
public class SecurityHelper {
    ...
    /**
     * Determina el rol bas�ndose en el nombre de usuario
     * 
    ...
    /**
     * Verifica si el usuario actual es acad�mico o administrador
     */
    ...
    /**
     * Obtiene el email del docente bas�ndose en el username
     * Convenci�n: docente_nombre =�� nombre@profesores.edu.ec
     * 
    ...
    public static String getEmailDocenteFromUsername(String username) {
        ...
        switch (user) {
            ...
            default:
                // Generar email basado en convenci�n
    ...
    /**
     * Valida si el usuario actual tiene permiso para operaci�n espec�fica
     * 
